...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    tl.to(headlineRef.current, {
      ...
      duration: 1,
      ease: "power3.out"
    }, "-=0.7").to(ctaRef.current, {
      opacity: 1,
      y: 0,
      filter: 'blur(0px)',
      duration: 0.8,
      ease: "back.out(1.7)"
    }, "-=0.5").to(splineRef.current, {
      opacity: 1,
      x: 0,
      duration: 1.5,
      ease: "power3.out"
  ...
  return <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div ref={splineRef} className="absolute inset-0 w-full h-full">
        <iframe src='https://my.spline.design/orb-LAzdoFqbWcOfPLInjHj366D5/' frameBorder='0' width='100%' height='100%' className="pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <button ref={ctaRef} onClick={scrollToProjects} className="glow-button text-lg px-8 py-4 font-semibold relative overflow-hidden group">
